...
* xref:dhw:sqldb:ssas.usp_persist_measures_translation_t.adoc[] - 
...
// tag::adocuspsteps[]
.Steps in [ssas].[usp_PERSIST_Measures_translation_T]
[cols="d,15a,d"]
|===
...
[source,sql,numbered]
----
TRUNCATE TABLE [ssas].[Measures_translation_T]
----
=====
...
FROM [ssas].[Measures_translation] AS S
----
=====
...
*/
CREATE   PROCEDURE [ssas].[usp_PERSIST_Measures_translation_T]
