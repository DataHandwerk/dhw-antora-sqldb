...
.Referenced Columns
--
* xref:repo.RepoObject.adoc#column-Inheritance_Source_fullname[+repo.RepoObject.Inheritance_Source_fullname+]
--

.Referencing Columns
--
* xref:property.RepoObjectProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-Inheritance_Source_fullname[+property.RepoObjectProperty_InheritanceType_resulting_InheritanceDefinition.Inheritance_Source_fullname+]
--
...
[#index-idx_RepoObjectProperty_InheritanceType_InheritanceDefinition2x_2]
...
[#index-idx_RepoObjectProperty_InheritanceType_InheritanceDefinition2x_3]
