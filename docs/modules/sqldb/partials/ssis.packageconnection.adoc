...
.Referencing Columns
--
* xref:docs.ssis_connectionlist.adoc#column-antoramodule[+docs.ssis_ConnectionList.AntoraModule+]
...
.Referencing Columns
--
* xref:docs.ssis_connectionlist.adoc#column-packagename[+docs.ssis_ConnectionList.PackageName+]
