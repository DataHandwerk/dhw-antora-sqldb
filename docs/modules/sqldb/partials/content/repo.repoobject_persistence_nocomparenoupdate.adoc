...
= repo.RepoObject_persistence_NoCompareNoUpdate - V
...
// tag::RepoObject_guid[]
3E2E3185-576E-EC11-8539-A81E8446D5B0
// end::RepoObject_guid[]
...
[#column-nocomparenoupdateunderlinecolumn]
=== NoCompareNoUpdate_Column
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparenoupdateunderlineunderline1]
=== idx_RepoObject_persistence_NoCompareNoUpdate++__++1
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparenoupdateunderlineunderline2]
=== idx_RepoObject_persistence_NoCompareNoUpdate++__++2
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparenoupdateunderlineunderline3]
=== idx_RepoObject_persistence_NoCompareNoUpdate++__++3
...
entity "puml-link:dhw:sqldb:repo.repoobject_persistence_nocomparenoupdate.adoc[]" as repo.RepoObject_persistence_NoCompareNoUpdate << V >> {
- idx_RepoObject_persistence_NoCompareNoUpdate__1

..
RepoObjectColumn_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoCompareNoUpdate__2

..
RepoObject_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoCompareNoUpdate__3
