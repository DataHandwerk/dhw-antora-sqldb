...
= ssas.model_json_316_tables_descriptions_multiline - V
...
.Referencing Columns
--
* xref:ssas.model_json_3161_tables_descriptions_stragg.adoc#column-repoobjectunderlineguid[+ssas.model_json_3161_tables_descriptions_StrAgg.RepoObject_guid+]
--
...
.Referencing Columns
--
* xref:ssas.model_json_3161_tables_descriptions_stragg.adoc#column-tablesunderlinename[+ssas.model_json_3161_tables_descriptions_StrAgg.tables_name+]
--
...
[#index-idxunderlinemodelunderlinejsonunderline316underlinetablesunderlinedescriptionsunderlinemultilineunderlineunderline1]
=== idx_model_json_316_tables_descriptions_multiline++__++1
...
[#index-idxunderlinemodelunderlinejsonunderline316underlinetablesunderlinedescriptionsunderlinemultilineunderlineunderline2]
...
entity "puml-link:dhw:sqldb:ssas.model_json_316_tables_descriptions_multiline.adoc[]" as ssas.model_json_316_tables_descriptions_multiline << V >> {
- idx_model_json_316_tables_descriptions_multiline__1

..
databasename; nvarchar(128)
tables_name; nvarchar(128)
--
- idx_model_json_316_tables_descriptions_multiline__2
