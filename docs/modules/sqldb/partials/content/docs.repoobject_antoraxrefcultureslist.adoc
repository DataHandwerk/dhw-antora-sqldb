...
= docs.RepoObject_AntoraXrefCulturesList - V
...
// tag::RepoObject_guid[]
7CB0089F-AE26-EC11-8529-A81E8446D5B0
// end::RepoObject_guid[]
...
[#index-idxunderlinerepoobjectunderlineantoraxrefcultureslistunderlineunderline1]
=== idx_RepoObject_AntoraXrefCulturesList++__++1
...
entity "puml-link:dhw:sqldb:docs.repoobject_antoraxrefcultureslist.adoc[]" as docs.RepoObject_AntoraXrefCulturesList << V >> {
- idx_RepoObject_AntoraXrefCulturesList__1
