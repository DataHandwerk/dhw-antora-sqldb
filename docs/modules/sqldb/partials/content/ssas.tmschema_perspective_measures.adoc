...
= ssas.TMSCHEMA_PERSPECTIVE_MEASURES - U
...
ssas.TMSCHEMA_PERSPECTIVE_MEASURES
...
[#index-pkunderlinetmschemaunderlineperspectiveunderlinemeasures]
...
* xref:dhw:sqldb:ssas.tmschema_perspective_measures.adoc[] - 
