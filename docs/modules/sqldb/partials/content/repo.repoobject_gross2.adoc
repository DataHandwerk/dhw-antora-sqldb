...
.Referenced Columns
--
* xref:repo.repoobject_columnlist.adoc#column-persistenceinsertcolumnlistsource[+repo.RepoObject_ColumnList.PersistenceInsertColumnListSource+]
--
...
.Referenced Columns
--
* xref:repo.repoobject_columnlist.adoc#column-persistencesrctgtcolumnlist[+repo.RepoObject_ColumnList.PersistenceSrcTgtColumnList+]
--
...
.Referenced Columns
--
* xref:repo.repoobject_columnlist.adoc#column-persistencetemptablecolumnlist[+repo.RepoObject_ColumnList.PersistenceTempTableColumnList+]
--
