...
= reference.usp_additional_Reference - P
...
// tag::RepoObject_guid[]
7DDAAA1B-681B-EC11-8520-A81E8446D5B0
// end::RepoObject_guid[]
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_additional_Reference]
[cols="d,15a,d"]
|===
...
*/
CREATE   PROCEDURE [reference].[usp_additional_Reference]
...
--
PRINT '[reference].[usp_additional_Reference]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
