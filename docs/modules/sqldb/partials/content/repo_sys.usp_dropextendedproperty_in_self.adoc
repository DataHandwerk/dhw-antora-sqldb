...
// tag::RepoObject_guid[]
873EFD10-0222-EC11-8524-A81E8446D5B0
// end::RepoObject_guid[]

== RepoObject_FullDisplayName2

// tag::RepoObject_FullDisplayName2[]
repo_sys.usp_DropExtendedProperty_in_self
...
* xref:dhw:sqldb:repo_sys.usp_dropextendedproperty_in_self.adoc[] - 
...
entity "puml-link:dhw:sqldb:repo_sys.usp_dropextendedproperty_in_self.adoc[]" as repo_sys.usp_DropExtendedProperty_in_self << P >> {
  --
}
....
