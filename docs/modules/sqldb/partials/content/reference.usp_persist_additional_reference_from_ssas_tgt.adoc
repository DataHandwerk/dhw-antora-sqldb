...
= reference.usp_PERSIST_additional_Reference_from_ssas_tgt - P
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_additional_Reference_from_ssas_tgt]
[cols="d,15a,d"]
|===
...
FROM [reference].[additional_Reference_from_ssas_src] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [reference].[additional_Reference_from_ssas_tgt] AS T
WHERE
...
*/
CREATE   PROCEDURE [reference].[usp_PERSIST_additional_Reference_from_ssas_tgt]
...
--
PRINT '[reference].[usp_PERSIST_additional_Reference_from_ssas_tgt]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_from_ssas_src]","log_target_object":"[reference].[additional_Reference_from_ssas_tgt]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',106,';',700,';',NULL);
...
SET @source_object = '[reference].[additional_Reference_from_ssas_src]'
SET @target_object = '[reference].[additional_Reference_from_ssas_tgt]'
