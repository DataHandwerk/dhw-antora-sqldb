...
.Referencing Columns
--
* xref:ssas.model_json_20.adoc#column-l1underlinecompatibilitylevel[+ssas.model_json_20.l1_compatibilityLevel+]
--
...
.Referencing Columns
--
* xref:ssas.model_json_20.adoc#column-l1underlineid[+ssas.model_json_20.l1_id+]
--


[#column-l1underlinemodelunderlinej]
=== l1_model_j
...
.Referencing Columns
--
* xref:ssas.model_json_20.adoc#column-l1underlinename[+ssas.model_json_20.l1_name+]
--
...
[#index-idxunderlinemodelunderlinejsonunderline10underlineunderline1]
=== idx_model_json_10++__++1
