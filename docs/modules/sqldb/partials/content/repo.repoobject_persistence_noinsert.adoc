...
= repo.RepoObject_persistence_NoInsert - V
...
// tag::RepoObject_guid[]
C673C77F-2C2D-ED11-8577-A81E8446D5B0
// end::RepoObject_guid[]

== RepoObject_FullDisplayName2

// tag::RepoObject_FullDisplayName2[]
repo.RepoObject_persistence_NoInsert
...
.Referenced Columns
--
* xref:repo.repoobject_persistence.adoc#column-columnlistnoinsert[+repo.RepoObject_persistence.ColumnListNoInsert+]
--
...
[#column-noinsertunderlinecolumn]
=== NoInsert_Column
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenoinsertunderlineunderline1]
=== idx_RepoObject_persistence_NoInsert++__++1
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenoinsertunderlineunderline2]
=== idx_RepoObject_persistence_NoInsert++__++2
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenoinsertunderlineunderline3]
=== idx_RepoObject_persistence_NoInsert++__++3
...
entity "puml-link:dhw:sqldb:repo.repoobject_persistence_noinsert.adoc[]" as repo.RepoObject_persistence_NoInsert << V >> {
- idx_RepoObject_persistence_NoInsert__1

..
RepoObjectColumn_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoInsert__2

..
RepoObject_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoInsert__3
