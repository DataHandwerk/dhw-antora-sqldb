...
= repo.usp_PERSIST_IndexColumn_union_T - P
...
// tag::adocuspsteps[]
.Steps in [repo].[usp_PERSIST_IndexColumn_union_T]
[cols="d,15a,d"]
|===
...
[source,sql,numbered]
----
TRUNCATE TABLE [repo].[IndexColumn_union_T]
----
=====
...
FROM [repo].[IndexColumn_union] AS S
----
=====
...
*/
CREATE   PROCEDURE [repo].[usp_PERSIST_IndexColumn_union_T]
...
--
PRINT '[repo].[usp_PERSIST_IndexColumn_union_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":400,"Name":"truncate persistence target","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_target_object":"[repo].[IndexColumn_union_T]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',91,';',400,';',NULL);
...
SET @source_object = NULL
SET @target_object = '[repo].[IndexColumn_union_T]'
...
/*{"ReportUspStep":[{"Number":800,"Name":"insert all","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[repo].[IndexColumn_union]","log_target_object":"[repo].[IndexColumn_union_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',91,';',800,';',NULL);
...
SET @source_object = '[repo].[IndexColumn_union]'
SET @target_object = '[repo].[IndexColumn_union_T]'
