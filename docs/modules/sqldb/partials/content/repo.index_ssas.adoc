...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-indexunderlinename[+ssas.IndexColumn_union.index_name+]
--
...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-isunderlineindexunderlineprimaryunderlinekey[+ssas.IndexColumn_union.is_index_primary_key+]
--
...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-isunderlineindexunderlineunique[+ssas.IndexColumn_union.is_index_unique+]
--
...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-repoobjectunderlineguid[+ssas.IndexColumn_union.RepoObject_guid+]
--
...
[#index-pkunderlineindexunderlinessas]
=== PK_Index_ssas
...
[#index-ukunderlineindexunderlinessasunderlineunderline1]
=== UK_Index_ssas++__++1
...
* xref:dhw:sqldb:repo.index_ssas.adoc[] - 
