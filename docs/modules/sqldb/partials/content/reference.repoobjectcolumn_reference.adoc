...
= reference.RepoObjectColumn_reference - V
...
.Referenced Columns
--
* xref:reference.repoobjectcolumn_reference_union.adoc#column-referencedunderlinerepoobjectcolumnunderlineguid[+reference.RepoObjectColumn_reference_union.referenced_RepoObjectColumn_guid+]
--
...
.Referenced Columns
--
* xref:reference.repoobjectcolumn_reference_union.adoc#column-referencingunderlinerepoobjectcolumnunderlineguid[+reference.RepoObjectColumn_reference_union.referencing_RepoObjectColumn_guid+]
--
...
.Referencing Columns
--
* xref:reference.repoobjectcolumn_reference_t.adoc#column-isunderlinereferencedunderlineobject[+reference.RepoObjectColumn_reference_T.is_referenced_object+]
--
...
.Referencing Columns
--
* xref:reference.repoobjectcolumn_reference_t.adoc#column-isunderlinereferencingunderlineobjectunderlineequalunderlinereferencedunderlineobject[+reference.RepoObjectColumn_reference_T.is_referencing_object_equal_referenced_object+]
--
...
.Referenced Columns
--
* xref:reference.repoobjectcolumn_reference_union.adoc#column-referencedunderlinerepoobjectunderlineguid[+reference.RepoObjectColumn_reference_union.referenced_RepoObject_guid+]
--
...
[#index-pkunderlinerepoobjectcolumnunderlinereference]
