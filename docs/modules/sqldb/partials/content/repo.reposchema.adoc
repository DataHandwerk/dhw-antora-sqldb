...
.Referencing Columns
--
* xref:repo.measure.adoc#column-measuresrepoobjektunderlineguid[+repo.Measure.MeasuresRepoObjekt_guid+]
--


[#column-reposchemaunderlinedescription]
...
* xref:repo.reposchema_ssas_tgt.adoc#column-reposchemaunderlinedescription[+repo.RepoSchema_ssas_tgt.RepoSchema_description+]
--
...
.Referencing Columns
--
* xref:repo.measure.adoc#column-measuresrepoobjektunderlinename[+repo.Measure.MeasuresRepoObjekt_name+]
--
...
"repo.RepoSchema::RepoSchema_description" <-- "repo.RepoSchema_ssas_tgt::RepoSchema_description"
