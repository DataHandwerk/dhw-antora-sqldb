...
.Referencing Columns
--
* xref:docs.antorapage_indexsemanticgroup.adoc#column-culturesunderlinename[+docs.AntoraPage_IndexSemanticGroup.cultures_name+]
--
...
[#index-idxunderlineindexsemanticgroupunderlineunderline1]
=== idx_IndexSemanticgroup++__++1
...
[#index-idxunderlineindexsemanticgroupunderlineunderline2]
=== idx_IndexSemanticgroup++__++2
...
* xref:dhw:sqldb:docs.antorapage_indexsemanticgroup.adoc[]
...
entity "puml-link:dhw:sqldb:docs.indexsemanticgroup.adoc[]" as docs.IndexSemanticgroup << V >> {
- idx_IndexSemanticgroup__1

..
IndexSemanticGroup; nvarchar(512)
--
- idx_IndexSemanticgroup__2
...
docs.IndexSemanticgroup <.. docs.AntoraPage_IndexSemanticGroup
docs.IndexSemanticgroupPatterndatatype <.. docs.IndexSemanticgroup
"docs.IndexSemanticgroup::cultures_name" <-- "docs.AntoraPage_IndexSemanticGroup::cultures_name"
