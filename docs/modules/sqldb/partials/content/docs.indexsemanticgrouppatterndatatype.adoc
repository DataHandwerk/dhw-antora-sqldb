...
= docs.IndexSemanticgroupPatterndatatype - V
...
.Referencing Columns
--
* xref:docs.indexsemanticgroup.adoc#column-indexsemanticgroup[+docs.IndexSemanticgroup.IndexSemanticGroup+]
--
...
.Referencing Columns
--
* xref:docs.indexsemanticgroup.adoc#column-culturesunderlinename[+docs.IndexSemanticgroup.cultures_name+]
--
...
[#index-pkunderlineindexsemanticgrouppatterndatatype]
=== PK_IndexSemanticgroupPatterndatatype
...
[#index-idxunderlineindexsemanticgrouppatterndatatypeunderlineunderline2]
=== idx_IndexSemanticgroupPatterndatatype++__++2
...
IndexPatternColumnDatatype; nvarchar(4000)
--
- idx_IndexSemanticgroupPatterndatatype__2
...
docs.fs_cleanStringForFilename <.. docs.IndexSemanticgroupPatterndatatype
...
docs.RepoObject_OutputFilter_T <.. docs.IndexSemanticgroupPatterndatatype
repo.Index_gross <.. docs.IndexSemanticgroupPatterndatatype
"docs.IndexSemanticgroupPatterndatatype::cultures_name" <-- "docs.IndexSemanticgroup::cultures_name"
"docs.IndexSemanticgroupPatterndatatype::IndexSemanticGroup" <-- "docs.IndexSemanticgroup::IndexSemanticGroup"
...
CREATE View docs.IndexSemanticgroupPatterndatatype
As
Select
...
Where
    ...
    And i.is_external    = 0
    And i.is_DocsOutput  = 1
    And i.is_DocsExclude = 0
Group By
    i.IndexSemanticGroup
  , i.IndexPatternColumnDatatype
  , rof.cultures_name
