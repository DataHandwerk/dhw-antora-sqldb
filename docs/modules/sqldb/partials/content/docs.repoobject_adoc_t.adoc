...
.Default: DF_RepoObject_Adoc_T_cultures_name
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Adoc_T_AdocContent
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Adoc_T_AdocContent1
[source,sql]
----
('')
----
...
.Referenced Columns
--
* xref:docs.repoobject_adoc.adoc#column-adocdescriptiontagscontent[+docs.RepoObject_Adoc.AdocDescriptionTagsContent+]
--
