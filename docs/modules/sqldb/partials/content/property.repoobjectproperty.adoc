...
property.RepoObjectProperty <.. property.usp_sync_ExtendedProperties_Sys2Repo_InsertUpdate
property.RepoObjectProperty_external_tgt <.. property.RepoObjectProperty
"property.RepoObjectProperty::inheritance" <-- "property.RepoObjectProperty_external_tgt::inheritance"
"property.RepoObjectProperty::inheritance" <-- "property.RepoObjectProperty_ForUpdate::inheritance"
"property.RepoObjectProperty::property_name" <-- "property.ExtendedProperty_Repo2Sys_level1::property_name"
"property.RepoObjectProperty::property_name" <-- "property.ExtendedProperty_Repo2Sys_level2_RepoObject::property_name"
"property.RepoObjectProperty::property_name" <-- "property.RepoObjectProperty_external_tgt::property_name"
"property.RepoObjectProperty::property_name" <-- "property.RepoObjectProperty_ForUpdate::property_name"
"property.RepoObjectProperty::property_name" <-- "property.RepoObjectProperty_SelectedPropertyName_split::property_name"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty::property_bigint"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty::property_float"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty::property_int"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty::property_money"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty::property_real"
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty_external_tgt::property_value"
...
"property.RepoObjectProperty::property_value" <-- "property.RepoObjectProperty_SelectedPropertyName_split::property_value"
"property.RepoObjectProperty::RepoObject_guid" <-- "property.ExtendedProperty_Repo2Sys_level1::RepoObject_guid"
"property.RepoObjectProperty::RepoObject_guid" <-- "property.ExtendedProperty_Repo2Sys_level2_RepoObject::RepoObject_guid"
"property.RepoObjectProperty::RepoObject_guid" <-- "property.RepoObjectProperty_external_tgt::RepoObject_guid"
"property.RepoObjectProperty::RepoObject_guid" <-- "property.RepoObjectProperty_ForUpdate::RepoObject_guid"
"property.RepoObjectProperty::RepoObject_guid" <-- "property.RepoObjectProperty_SelectedPropertyName_split::RepoObject_guid"
"property.RepoObjectProperty::RepoObjectProperty_id" <-- "property.RepoObjectProperty_external_tgt::RepoObjectProperty_id"
