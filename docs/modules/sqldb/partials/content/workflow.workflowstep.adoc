...
.Referencing Columns
--
* xref:workflow.workflowstep_forupdate.adoc#column-isunderlineactive[+workflow.WorkflowStep_ForUpdate.is_active+]
--


[#column-isunderlinepossiblereferenced]
...
.Referencing Columns
--
* xref:workflow.workflowstep_active.adoc#column-isunderlinepossiblereferenced[+workflow.WorkflowStep_active.is_PossibleReferenced+]
* xref:workflow.workflowstep_forupdate.adoc#column-isunderlinepossiblereferenced[+workflow.WorkflowStep_ForUpdate.is_PossibleReferenced+]
--
...
.Referenced Columns
--
* xref:workflow.workflowstep_src.adoc#column-procedureunderlinerepoobjectunderlineguid[+workflow.WorkflowStep_src.Procedure_RepoObject_guid+]
--
...
* xref:workflow.workflowstep_forupdate.adoc#column-procedureunderlinerepoobjectunderlineguid[+workflow.WorkflowStep_ForUpdate.Procedure_RepoObject_guid+]
--
...
.Referenced Columns
--
* xref:workflow.workflowstep_src.adoc#column-workflowunderlineid[+workflow.WorkflowStep_src.Workflow_id+]
--

.Referencing Columns
--
* xref:workflow.workflowstep_active.adoc#column-workflowunderlineid[+workflow.WorkflowStep_active.Workflow_id+]
* xref:workflow.workflowstep_forupdate.adoc#column-workflowunderlineid[+workflow.WorkflowStep_ForUpdate.Workflow_id+]
--
...
[#index-idxunderlineworkflowstepunderlineunderline1]
...
referenced: xref:workflow.workflow.adoc[], xref:workflow.workflow.adoc#index-pkunderlineworkflow[+PK_Workflow+]
* is disabled


[#index-idxunderlineworkflowstepunderlineunderline2]
...
* xref:dhw:sqldb:workflow.workflowstep.adoc[] - 
...
"workflow.WorkflowStep_src::Procedure_RepoObject_guid" <-- "workflow.WorkflowStep::Procedure_RepoObject_guid"
"workflow.WorkflowStep_src::Workflow_id" <-- "workflow.WorkflowStep::Workflow_id"
