...
= ssis.usp_PERSIST_PackageTask_Dft_Component_output_externalMetadataColumn_tgt - P
...
// tag::adocuspsteps[]
.Steps in [ssis].[usp_PERSIST_PackageTask_Dft_Component_output_externalMetadataColumn_tgt]
[cols="d,15a,d"]
|===
...
INTO
  #source
FROM [ssis].[PackageTask_Dft_Component_output_externalMetadataColumn_src]
----
=====
