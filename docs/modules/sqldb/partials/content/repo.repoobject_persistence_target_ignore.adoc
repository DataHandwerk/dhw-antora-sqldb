...
= repo.RepoObject_persistence_target_Ignore - V
...
// tag::RepoObject_guid[]
3F2E3185-576E-EC11-8539-A81E8446D5B0
// end::RepoObject_guid[]
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinetargetunderlineignoreunderlineunderline1]
=== idx_RepoObject_persistence_target_Ignore++__++1
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinetargetunderlineignoreunderlineunderline2]
=== idx_RepoObject_persistence_target_Ignore++__++2
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinetargetunderlineignoreunderlineunderline3]
=== idx_RepoObject_persistence_target_Ignore++__++3
...
entity "puml-link:dhw:sqldb:repo.repoobject_persistence_target_ignore.adoc[]" as repo.RepoObject_persistence_target_Ignore << V >> {
- idx_RepoObject_persistence_target_Ignore__1

..
RepoObjectColumn_guid; uniqueidentifier
--
- idx_RepoObject_persistence_target_Ignore__2

..
RepoObject_guid; uniqueidentifier
--
- idx_RepoObject_persistence_target_Ignore__3
