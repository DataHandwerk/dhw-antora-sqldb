...
.Referencing Columns
--
* xref:repo.index_sqlconstraint_pkuq.adoc#column-indexunderlineguid[+repo.Index_SqlConstraint_PkUq.index_guid+]
...
* xref:repo.index_settings_forupdate.adoc#column-indexunderlinename[+repo.Index_Settings_ForUpdate.index_name+]
--
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-indexunderlinetype[+repo.Index_gross.index_type+]
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-isunderlineindexunderlinedisabled[+repo.Index_gross.is_index_disabled+]
--
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-isunderlineindexunderlineprimaryunderlinekey[+repo.Index_gross.is_index_primary_key+]
--
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-isunderlineindexunderlinereal[+repo.Index_gross.is_index_real+]
--
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-isunderlineindexunderlineunique[+repo.Index_gross.is_index_unique+]
--
...
* xref:repo.index_settings_forupdate.adoc#column-parentunderlinerepoobjectunderlineguid[+repo.Index_Settings_ForUpdate.parent_RepoObject_guid+]
* xref:repo.index_sqlconstraint_pkuq.adoc#column-parentunderlinerepoobjectunderlineguid[+repo.Index_SqlConstraint_PkUq.parent_RepoObject_guid+]
--
...
.Referencing Columns
--
* xref:repo.index_gross.adoc#column-referencedunderlineindexunderlineguid[+repo.Index_gross.referenced_index_guid+]
--
...
[#index-pkunderlineindexunderlineunion]
=== PK_Index_union
