...
= reference.RepoObjectColumn_ReferencedList - V
...
.Referencing Columns
--
* xref:repo.repoobjectcolumn_gross2.adoc#column-antorareferencedcolumnlist[+repo.RepoObjectColumn_gross2.AntoraReferencedColumnList+]
--
...
[#index-idxunderlinerepoobjectcolumnunderlinereferencedlistunderlineunderline1]
