...
= property.usp_PERSIST_PropertyName_Measure_T - P
...
// tag::adocuspsteps[]
.Steps in [property].[usp_PERSIST_PropertyName_Measure_T]
[cols="d,15a,d"]
|===
...
FROM [property].[PropertyName_Measure] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [property].[PropertyName_Measure_T] AS T
WHERE
...
*/
CREATE   PROCEDURE [property].[usp_PERSIST_PropertyName_Measure_T]
...
--
PRINT '[property].[usp_PERSIST_PropertyName_Measure_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[property].[PropertyName_Measure]","log_target_object":"[property].[PropertyName_Measure_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',140,';',700,';',NULL);
...
SET @source_object = '[property].[PropertyName_Measure]'
SET @target_object = '[property].[PropertyName_Measure_T]'
