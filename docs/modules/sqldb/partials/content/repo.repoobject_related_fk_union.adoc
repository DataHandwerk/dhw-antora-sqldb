...
.Referencing Columns
--
* xref:docs.repoobject_plantuml_fkreflist.adoc#column-repoobjectunderlineguid[+docs.RepoObject_PlantUml_FkRefList.RepoObject_guid+]
* xref:docs.repoobject_plantuml_pumlentityfklist.adoc#column-repoobjectunderlineguid[+docs.RepoObject_PlantUml_PumlEntityFkList.RepoObject_guid+]
--


[#column-includedunderlinerepoobjectunderlineguid]
...
[#column-includedunderlinerepoobjectunderlinefullname2]
...
[#column-includedunderlineschemaname]
=== included_SchemaName
...
.Referencing Columns
--
* xref:docs.repoobject_plantuml_fkreflist.adoc#column-repoobjectunderlinefullname2[+docs.RepoObject_PlantUml_FkRefList.RepoObject_fullname2+]
...
[#index-pkunderlinerepoobjectunderlinerelatedunderlinefkunderlineunion]
...
"repo.RepoObject_related_FK_union::RepoObject_fullname2" <-- "docs.RepoObject_PlantUml_FkRefList::RepoObject_fullname2"
"repo.RepoObject_related_FK_union::RepoObject_guid" <-- "docs.RepoObject_PlantUml_FkRefList::RepoObject_guid"
