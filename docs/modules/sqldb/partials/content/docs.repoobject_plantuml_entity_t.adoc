...
= docs.RepoObject_Plantuml_Entity_T - U
...
.Default: DF_RepoObject_Plantuml_Entity_T_cultures_name
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Plantuml_Entity_T_RepoObject_fullname2
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Plantuml_Entity_T_RepoObject_PumlOnlyPkOrNotHidden1
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Plantuml_Entity_T_RepoObject_PumlOnlyPkOrIndex1
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Plantuml_Entity_T_RepoObject_PumlOnlyPkOrNotHidden
[source,sql]
----
('')
----
...
.Default: DF_RepoObject_Plantuml_Entity_T_RepoObject_fullname21
[source,sql]
----
('')
----
