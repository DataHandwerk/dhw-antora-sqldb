...
= ssis.usp_PERSIST_PackageTask_Dft_Component_input_externalMetadataColumn_tgt - P
...
// tag::adocuspsteps[]
.Steps in [ssis].[usp_PERSIST_PackageTask_Dft_Component_input_externalMetadataColumn_tgt]
[cols="d,15a,d"]
|===
...
----
DELETE T
FROM [ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_tgt] AS T
WHERE
NOT EXISTS
...
*/
CREATE   PROCEDURE [ssis].[usp_PERSIST_PackageTask_Dft_Component_input_externalMetadataColumn_tgt]
...
--
PRINT '[ssis].[usp_PERSIST_PackageTask_Dft_Component_input_externalMetadataColumn_tgt]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
SET @source_object = '[ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_src]'
...
/*{"ReportUspStep":[{"Number":500,"Name":"delete persistence target missing in source","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"#source","log_target_object":"[ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_tgt]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',132,';',500,';',NULL);
...
SET @target_object = '[ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_tgt]'
...
/*{"ReportUspStep":[{"Number":600,"Name":"update changed","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"#source","log_target_object":"[ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_tgt]","log_flag_InsertUpdateDelete":"U"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',132,';',600,';',NULL);
...
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"#source","log_target_object":"[ssis].[PackageTask_Dft_Component_input_externalMetadataColumn_tgt]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',132,';',700,';',NULL);
