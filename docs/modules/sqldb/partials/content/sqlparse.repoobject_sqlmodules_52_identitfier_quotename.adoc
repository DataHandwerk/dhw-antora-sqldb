...
= sqlparse.RepoObject_SqlModules_52_Identitfier_QuoteName - V
...
.Referenced Columns
--
* xref:sqlparse.repoobject_sqlmodules_51_identitfier.adoc#column-sourceunderlinecolumn[+sqlparse.RepoObject_SqlModules_51_Identitfier.source_column+]
--
...
.Referenced Columns
--
* xref:sqlparse.repoobject_sqlmodules_51_identitfier.adoc#column-sourceunderlinetable[+sqlparse.RepoObject_SqlModules_51_Identitfier.source_table+]
--
...
[#index-idxunderlinerepoobjectunderlinesqlmodulesunderline52underlineidentitfierunderlinequotenameunderlineunderline1]
...
[#index-idxunderlinerepoobjectunderlinesqlmodulesunderline52underlineidentitfierunderlinequotenameunderlineunderline2]
