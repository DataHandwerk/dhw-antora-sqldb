...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-indexunderlinecolumnunderlineid[+ssas.IndexColumn_union.index_column_id+]
--
...
.Referenced Columns
--
* xref:ssas.indexcolumn_union.adoc#column-repoobjectcolumnunderlineguid[+ssas.IndexColumn_union.RepoObjectColumn_guid+]
--
...
[#index-pkunderlineindexcolumnunderlinessas]
=== PK_IndexColumn_ssas
...
[#index-idxunderlineindexcolumnunderlinessasunderlineunderline2]
...
[#index-idxunderlineindexcolumnunderlinessasunderlineunderline3]
...
* xref:dhw:sqldb:repo.indexcolumn_ssas.adoc[] - 
