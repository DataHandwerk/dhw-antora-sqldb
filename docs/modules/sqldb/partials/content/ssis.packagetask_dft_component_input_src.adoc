...
= ssis.PackageTask_Dft_Component_input_src - V
...
[#index-idxunderlinepackagetaskunderlinedftunderlinecomponentunderlineinputunderlinesrcunderlineunderline3]
=== idx_PackageTask_Dft_Component_input_src++__++3
...
input_refId; varchar(max)
--
- idx_PackageTask_Dft_Component_input_src__2

..
AntoraModule; varchar(50)
PackageName; varchar(200)
--
- idx_PackageTask_Dft_Component_input_src__3
