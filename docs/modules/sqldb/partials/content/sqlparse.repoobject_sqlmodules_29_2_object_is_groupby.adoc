...
// tag::RepoObject_guid[]
FD8F291C-9D61-EB11-84DC-A81E8446D5B0
// end::RepoObject_guid[]
...
.Referencing Columns
--
* xref:sqlparse.repoobject_sqlmodules_39_object.adoc#column-hasunderlinegroupby[+sqlparse.RepoObject_SqlModules_39_object.has_GroupBy+]
--
...
[#index-idxunderlinerepoobjectunderlinesqlmodulesunderline29underline2underlineobjectunderlineisunderlinegroupbyunderlineunderline1]
