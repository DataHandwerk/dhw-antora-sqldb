...
= reference.RepoObjectColumn_ReferencingList - V
...
.Referencing Columns
--
* xref:repo.repoobjectcolumn_gross2.adoc#column-antorareferencingcolumnlist[+repo.RepoObjectColumn_gross2.AntoraReferencingColumnList+]
--
...
[#index-idxunderlinerepoobjectcolumnunderlinereferencinglistunderlineunderline1]
