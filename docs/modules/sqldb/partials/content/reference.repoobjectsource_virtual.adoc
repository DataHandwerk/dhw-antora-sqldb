...
= reference.RepoObjectSource_virtual - U
...
.Referencing Columns
--
* xref:reference.repoobject_reference_virtual.adoc#column-referencingunderlinerepoobjectunderlineguid[+reference.RepoObject_reference_virtual.referencing_RepoObject_guid+]
--
...
.Referencing Columns
--
* xref:reference.repoobject_reference_virtual.adoc#column-referencedunderlinerepoobjectunderlineguid[+reference.RepoObject_reference_virtual.referenced_RepoObject_guid+]
--
...
[#index-pkunderlinerepoobjectsourceunderlinevirtual]
...
[#index-idxunderlinerepoobjectsourceunderlinevirtualunderlineunderline1]
...
[#index-idxunderlinerepoobjectsourceunderlinevirtualunderlineunderline2]
