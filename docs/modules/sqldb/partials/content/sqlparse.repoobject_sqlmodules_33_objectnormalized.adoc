...
= sqlparse.RepoObject_SqlModules_33_ObjectNormalized - V
...
[#column-minunderlinerownumberunderlineperunderlinenormalized]
...
[#index-pkunderlinerepoobjectunderlinesqlmodulesunderline33underlineobjectnormalized]
...
[#index-idxunderlinerepoobjectunderlinesqlmodulesunderline33underlineobjectnormalizedunderlineunderline2]
=== idx_RepoObject_SqlModules_33_ObjectNormalized++__++2
...
normalized; nvarchar(max)
--
- idx_RepoObject_SqlModules_33_ObjectNormalized__2
