...
= property.PropertyName_Measure - V
...
.Referencing Columns
--
* xref:property.propertyname_measure_t.adoc#column-propertyunderlinename[+property.PropertyName_Measure_T.property_name+]
--
...
[#index-pkunderlinepropertynameunderlinemeasure]
=== PK_PropertyName_Measure
...
// tag::pk_index_guid[]
9BFAC491-464D-EC11-8531-A81E8446D5B0
// end::pk_index_guid[]
