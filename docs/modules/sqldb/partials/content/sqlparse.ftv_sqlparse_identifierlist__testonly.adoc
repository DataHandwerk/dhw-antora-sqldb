...
= sqlparse.ftv_sqlparse_IdentifierList__TestOnly - IF
...
* xref:dhw:sqldb:sqlparse.ftv_sqlparse_identifierlist__testonly.adoc[] - 
...
entity "puml-link:dhw:sqldb:sqlparse.ftv_sqlparse_identifierlist__testonly.adoc[]" as sqlparse.ftv_sqlparse_IdentifierList__TestOnly << IF >> {
...
sqlparse.ftv_sqlparse_with_some_children <.. sqlparse.ftv_sqlparse_IdentifierList__TestOnly
