...
= docs.usp_AntoraExport_SsisPage - P
...
// tag::RepoObject_guid[]
8D9A07F7-C23C-EC11-852D-A81E8446D5B0
// end::RepoObject_guid[]
...
// tag::adocuspsteps[]
.Steps in [docs].[usp_AntoraExport_SsisPage]
[cols="d,15a,d"]
|===
...
|410
|
*export FROM [repo].[fs_get_parameter_value]('AntoraPageTemplate', 'ssis_page_content')*
