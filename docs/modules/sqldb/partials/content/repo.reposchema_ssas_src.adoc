...
[#index-pkunderlinereposchemaunderlinessasunderlinesrc]
...
// tag::pk_index_guid[]
F7416ACD-5C1D-EC11-8522-A81E8446D5B0
// end::pk_index_guid[]
...
"repo.RepoSchema_ssas_src::RepoSchema_description" <-- "repo.RepoSchema_ssas_tgt::RepoSchema_description"
