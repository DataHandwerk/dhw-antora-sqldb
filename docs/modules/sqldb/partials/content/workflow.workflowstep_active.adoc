...
= workflow.WorkflowStep_active - V
...
.Referenced Columns
--
* xref:workflow.workflowstep.adoc#column-isunderlinepossiblereferenced[+workflow.WorkflowStep.is_PossibleReferenced+]
--
...
.Referenced Columns
--
* xref:workflow.workflowstep.adoc#column-procedureunderlinerepoobjectunderlineguid[+workflow.WorkflowStep.Procedure_RepoObject_guid+]
--

.Referencing Columns
--
* xref:workflow.biml_task.adoc#column-procedureunderlinerepoobjectunderlineguid[+workflow.Biml_Task.Procedure_RepoObject_guid+]
--
...
.Referenced Columns
--
* xref:workflow.workflowstep.adoc#column-workflowunderlineid[+workflow.WorkflowStep.Workflow_id+]
--

.Referencing Columns
--
* xref:workflow.biml_task.adoc#column-workflowunderlineid[+workflow.Biml_Task.Workflow_id+]
--
...
.Referencing Columns
--
* xref:workflow.biml_task.adoc#column-workflowunderlinename[+workflow.Biml_Task.Workflow_Name+]
--
...
[#index-idxunderlineworkflowstepunderlineactiveunderlineunderline1]
...
[#index-idxunderlineworkflowstepunderlineactiveunderlineunderline2]
...
[#index-idxunderlineworkflowstepunderlineactiveunderlineunderline3]
...
"workflow.WorkflowStep_active::Procedure_RepoObject_guid" <-- "workflow.Biml_Task::Procedure_RepoObject_guid"
"workflow.WorkflowStep_active::Workflow_id" <-- "workflow.Biml_Task::Workflow_id"
"workflow.WorkflowStep_active::Workflow_Name" <-- "workflow.Biml_Task::Workflow_Name"
...
From
    ...
    Inner Join
        repo.RepoObject   As ro
            On
            T1.Procedure_RepoObject_guid = ro.RepoObject_guid
Where
    ( T1.is_active     = 1 )
    And ( T2.is_active = 1 )
