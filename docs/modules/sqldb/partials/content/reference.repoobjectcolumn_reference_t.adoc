...
= reference.RepoObjectColumn_reference_T - U
...
.Default: DF_RepoObjectColumn_reference_T_referenced_is_external
[source,sql]
----
((0))
----
...
.Default: DF_RepoObjectColumn_reference_T_referencing_is_external
[source,sql]
----
((0))
----
