...
= repo.usp_sync_guid_RepoObject_ssas - P
...
// tag::RepoObject_guid[]
929CF1C3-0B08-EC11-8515-A81E8446D5B0
// end::RepoObject_guid[]

== RepoObject_FullDisplayName2

// tag::RepoObject_FullDisplayName2[]
repo.usp_sync_guid_RepoObject_ssas
...
// tag::adocuspsteps[]
.Steps in [repo].[usp_sync_guid_RepoObject_ssas]
[cols="d,15a,d"]
|===
...
// tag::description[]
* synchronizes RepoObject_guid with [ssas].[TMSCHEMA_TABLES_T]
// end::description[]
...
// tag::exampleusage[]
EXEC [repo].[usp_sync_guid_RepoObject_ssas]
// end::exampleusage[]
...
*/
CREATE   PROCEDURE [repo].[usp_sync_guid_RepoObject_ssas]
...
--
PRINT '[repo].[usp_sync_guid_RepoObject_ssas]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
BEGIN
PRINT CONCAT('usp_id;Number;Parent_Number: ',76,';',110,';',100);
