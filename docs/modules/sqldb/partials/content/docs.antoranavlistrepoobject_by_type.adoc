...
= docs.AntoraNavListRepoObject_by_type - V
...
[#index-pkunderlineantoranavlistrepoobjectunderlinebyunderlinetype]
...
[#index-idxunderlineantoranavlistrepoobjectunderlinebyunderlinetypeunderlineunderline2]
=== idx_AntoraNavListRepoObject_by_type++__++2
...
type; char(2)
--
- idx_AntoraNavListRepoObject_by_type__2
