...
= repo.usp_PERSIST_RepoObjectColumn_external_tgt - P
...
repo.usp_PERSIST_RepoObjectColumn_external_tgt
...
// tag::adocuspsteps[]
.Steps in [repo].[usp_PERSIST_RepoObjectColumn_external_tgt]
[cols="d,15a,d"]
|===
...
----
DELETE T
FROM [repo].[RepoObjectColumn_external_tgt] AS T
WHERE
NOT EXISTS
(SELECT 1 FROM [repo].[RepoObjectColumn_external_src] AS S
WHERE
...
FROM [repo].[RepoObjectColumn_external_tgt] AS T
INNER JOIN [repo].[RepoObjectColumn_external_src] AS S
ON
T.[RepoObjectColumn_guid] = S.[RepoObjectColumn_guid]
...
FROM [repo].[RepoObjectColumn_external_src] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [repo].[RepoObjectColumn_external_tgt] AS T
...
*/
CREATE   PROCEDURE [repo].[usp_PERSIST_RepoObjectColumn_external_tgt]
...
--
PRINT '[repo].[usp_PERSIST_RepoObjectColumn_external_tgt]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":500,"Name":"delete persistence target missing in source","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[repo].[RepoObjectColumn_external_src]","log_target_object":"[repo].[RepoObjectColumn_external_tgt]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',98,';',500,';',NULL);
...
SET @source_object = '[repo].[RepoObjectColumn_external_src]'
SET @target_object = '[repo].[RepoObjectColumn_external_tgt]'
...
/*{"ReportUspStep":[{"Number":600,"Name":"update changed","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[repo].[RepoObjectColumn_external_src]","log_target_object":"[repo].[RepoObjectColumn_external_tgt]","log_flag_InsertUpdateDelete":"U"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',98,';',600,';',NULL);
...
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[repo].[RepoObjectColumn_external_src]","log_target_object":"[repo].[RepoObjectColumn_external_tgt]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',98,';',700,';',NULL);
