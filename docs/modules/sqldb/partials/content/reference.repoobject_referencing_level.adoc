...
* xref:dhw:sqldb:reference.repoobject_referencing_level.adoc[] - 
...
entity "puml-link:dhw:sqldb:reference.repoobject_referencing_level.adoc[]" as reference.RepoObject_referencing_level << V >> {
  - a : (int)
  --
}
....
