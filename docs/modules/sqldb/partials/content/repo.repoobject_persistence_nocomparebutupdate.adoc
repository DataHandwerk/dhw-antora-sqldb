...
= repo.RepoObject_persistence_NoCompareButUpdate - V
...
// tag::RepoObject_guid[]
3D2E3185-576E-EC11-8539-A81E8446D5B0
// end::RepoObject_guid[]
...
[#column-nocomparebutupdateunderlinecolumn]
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparebutupdateunderlineunderline1]
=== idx_RepoObject_persistence_NoCompareButUpdate++__++1
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparebutupdateunderlineunderline2]
=== idx_RepoObject_persistence_NoCompareButUpdate++__++2
...
[#index-idxunderlinerepoobjectunderlinepersistenceunderlinenocomparebutupdateunderlineunderline3]
=== idx_RepoObject_persistence_NoCompareButUpdate++__++3
...
entity "puml-link:dhw:sqldb:repo.repoobject_persistence_nocomparebutupdate.adoc[]" as repo.RepoObject_persistence_NoCompareButUpdate << V >> {
- idx_RepoObject_persistence_NoCompareButUpdate__1

..
RepoObjectColumn_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoCompareButUpdate__2

..
RepoObject_guid; uniqueidentifier
--
- idx_RepoObject_persistence_NoCompareButUpdate__3
