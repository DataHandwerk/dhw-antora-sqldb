...
// tag::RepoObject_guid[]
FCE6A70A-8A06-EC11-8515-A81E8446D5B0
// end::RepoObject_guid[]
...
.Default: DF_TMSCHEMA_KPIS_databasename
[source,sql]
----
(N'mydatabase')
----
...
[#index-pkunderlinetmschemaunderlinekpis]
=== PK_TMSCHEMA_KPIS
...
* xref:dhw:sqldb:ssas.tmschema_kpis.adoc[] - 
...
// tag::pk_index_guid[]
FEE6A70A-8A06-EC11-8515-A81E8446D5B0
// end::pk_index_guid[]
