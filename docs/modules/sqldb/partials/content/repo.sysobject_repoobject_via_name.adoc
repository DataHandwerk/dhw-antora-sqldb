...
= repo.SysObject_RepoObject_via_name - V
...
.Referencing Columns
--
* xref:repo_sys.indexcolumn_unique.adoc#column-indexunderlineguid[+repo_sys.IndexColumn_unique.index_guid+]
...
.Referencing Columns
--
* xref:repo_sys.sql_expression_dependencies.adoc#column-referencingunderlinetypeunderlinedesciption[+repo_sys.sql_expression_dependencies.referencing_type_desciption+]
* xref:repo_sys.sql_expression_dependencies.adoc#column-referencedunderlinetypeunderlinedesciption[+repo_sys.sql_expression_dependencies.referenced_type_desciption+]
--
...
[#index-idxunderlinesysobjectunderlinerepoobjectunderlineviaunderlinenameunderlineunderline1]
...
[#index-idxunderlinesysobjectunderlinerepoobjectunderlineviaunderlinenameunderlineunderline2]
...
[#index-idxunderlinesysobjectunderlinerepoobjectunderlineviaunderlinenameunderlineunderline3]
...
[#index-idxunderlinesysobjectunderlinerepoobjectunderlineviaunderlinenameunderlineunderline4]
=== idx_SysObject_RepoObject_via_name++__++4
