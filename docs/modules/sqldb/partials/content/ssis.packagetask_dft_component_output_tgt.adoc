...
= ssis.PackageTask_Dft_Component_output_tgt - V
...
[#index-idxunderlinepackagetaskunderlinedftunderlinecomponentunderlineoutputunderlinetgtunderlineunderline2]
=== idx_PackageTask_Dft_Component_output_tgt++__++2
...
[#index-idxunderlinepackagetaskunderlinedftunderlinecomponentunderlineoutputunderlinetgtunderlineunderline3]
=== idx_PackageTask_Dft_Component_output_tgt++__++3
...
output_refId; varchar(max)
--
- idx_PackageTask_Dft_Component_output_tgt__2

..
AntoraModule; varchar(50)
PackageName; varchar(200)
--
- idx_PackageTask_Dft_Component_output_tgt__3
