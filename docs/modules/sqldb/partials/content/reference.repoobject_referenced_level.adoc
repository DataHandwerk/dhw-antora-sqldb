...
* xref:dhw:sqldb:reference.repoobject_referenced_level.adoc[] - 
...
entity "puml-link:dhw:sqldb:reference.repoobject_referenced_level.adoc[]" as reference.RepoObject_referenced_level << V >> {
  - a : (int)
  --
}
....
