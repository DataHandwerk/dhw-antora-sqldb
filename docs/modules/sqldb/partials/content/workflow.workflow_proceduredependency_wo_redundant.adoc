...
= workflow.Workflow_ProcedureDependency_wo_redundant - V
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinewounderlineredundantunderlineunderline1]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinewounderlineredundantunderlineunderline2]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinewounderlineredundantunderlineunderline3]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinewounderlineredundantunderlineunderline4]
...
* xref:dhw:sqldb:workflow.workflow_proceduredependency_wo_redundant.adoc[] - 
...
entity "puml-link:dhw:sqldb:workflow.workflow_proceduredependency_wo_redundant.adoc[]" as workflow.Workflow_ProcedureDependency_wo_redundant << V >> {
- idx_Workflow_ProcedureDependency_wo_redundant__1

..
Workflow_id; int
--
- idx_Workflow_ProcedureDependency_wo_redundant__2

..
referenced_Procedure_RepoObject_guid; uniqueidentifier
referencing_Procedure_RepoObject_guid; uniqueidentifier
--
- idx_Workflow_ProcedureDependency_wo_redundant__3

..
referenced_Procedure_RepoObject_guid; uniqueidentifier
--
- idx_Workflow_ProcedureDependency_wo_redundant__4
