...
= docs.usp_PERSIST_RepoObject_OutputFilter_T - P
...
// tag::adocuspsteps[]
.Steps in [docs].[usp_PERSIST_RepoObject_OutputFilter_T]
[cols="d,15a,d"]
|===
...
[source,sql,numbered]
----
TRUNCATE TABLE [docs].[RepoObject_OutputFilter_T]
----
=====
...
FROM [docs].[RepoObject_OutputFilter] AS S
----
=====
...
*/
CREATE   PROCEDURE [docs].[usp_PERSIST_RepoObject_OutputFilter_T]
...
--
PRINT '[docs].[usp_PERSIST_RepoObject_OutputFilter_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":400,"Name":"truncate persistence target","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_target_object":"[docs].[RepoObject_OutputFilter_T]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',113,';',400,';',NULL);
...
SET @source_object = NULL
SET @target_object = '[docs].[RepoObject_OutputFilter_T]'
...
/*{"ReportUspStep":[{"Number":800,"Name":"insert all","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[docs].[RepoObject_OutputFilter]","log_target_object":"[docs].[RepoObject_OutputFilter_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',113,';',800,';',NULL);
...
SET @source_object = '[docs].[RepoObject_OutputFilter]'
SET @target_object = '[docs].[RepoObject_OutputFilter_T]'
