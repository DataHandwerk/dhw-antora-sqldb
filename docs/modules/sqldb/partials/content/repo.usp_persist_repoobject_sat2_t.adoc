...
= repo.usp_PERSIST_RepoObject_sat2_T - P
...
// tag::adocuspsteps[]
.Steps in [repo].[usp_PERSIST_RepoObject_sat2_T]
[cols="d,15a,d"]
|===
...
[source,sql,numbered]
----
TRUNCATE TABLE [repo].[RepoObject_sat2_T]
----
=====
...
FROM [repo].[RepoObject_sat2] AS S
----
=====
...
*/
CREATE   PROCEDURE [repo].[usp_PERSIST_RepoObject_sat2_T]
...
--
PRINT '[repo].[usp_PERSIST_RepoObject_sat2_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":400,"Name":"truncate persistence target","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_target_object":"[repo].[RepoObject_sat2_T]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',114,';',400,';',NULL);
...
SET @source_object = NULL
SET @target_object = '[repo].[RepoObject_sat2_T]'
...
/*{"ReportUspStep":[{"Number":800,"Name":"insert all","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[repo].[RepoObject_sat2]","log_target_object":"[repo].[RepoObject_sat2_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',114,';',800,';',NULL);
...
SET @source_object = '[repo].[RepoObject_sat2]'
SET @target_object = '[repo].[RepoObject_sat2_T]'
