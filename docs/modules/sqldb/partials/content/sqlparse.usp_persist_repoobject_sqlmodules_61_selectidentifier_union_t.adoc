...
= sqlparse.usp_PERSIST_RepoObject_SqlModules_61_SelectIdentifier_Union_T - P
...
// tag::adocuspsteps[]
.Steps in [sqlparse].[usp_PERSIST_RepoObject_SqlModules_61_SelectIdentifier_Union_T]
[cols="d,15a,d"]
|===
