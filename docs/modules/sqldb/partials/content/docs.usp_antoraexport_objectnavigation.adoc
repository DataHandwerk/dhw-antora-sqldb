...
= docs.usp_AntoraExport_ObjectNavigation - P
...
// tag::RepoObject_guid[]
8B9A07F7-C23C-EC11-852D-A81E8446D5B0
// end::RepoObject_guid[]
...
// tag::adocuspsteps[]
.Steps in [docs].[usp_AntoraExport_ObjectNavigation]
[cols="d,15a,d"]
|===
...
|610
|
*export partial_content FROM [docs].[AntoraPage_ObjectBySchema] and [docs].[AntoraPage_ObjectByType]*
...
*/
CREATE   PROCEDURE [docs].[usp_AntoraExport_ObjectNavigation]
@isTrustedConnection BIT = 1 /* specify whether you are connecting to the SQL instance with a trusted connection (Windows Authentication) or not */
,@userName NVARCHAR(250) = 'loginName' /* If isTrustedConnection is set to 0 then you will need to add username and password for connecting to the SQL Server instance */
,@password NVARCHAR(250) = 'password'
,
...
--
PRINT '[docs].[usp_AntoraExport_ObjectNavigation]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
