...
= docs.AntoraPage_IndexSemanticGroup - V
...
// tag::RepoObject_guid[]
8A1293B9-DE96-EB11-84F4-A81E8446D5B0
// end::RepoObject_guid[]
...
[#index-pkunderlineantorapageunderlineindexsemanticgroup]
=== PK_AntoraPage_IndexSemanticGroup

* IndexSemanticGroup: xref:other/indexsemanticgroup.adoc#startbnoblankgroupendb[no_group]
+
--
* <<column-page_content>>; nvarchar(max)
--
* PK, Unique, Real: 1, 1, 0


[#index-idxunderlineantorapageunderlineindexsemanticgroupunderlineunderline2]
=== idx_AntoraPage_IndexSemanticGroup++__++2
...
// tag::pk_index_guid[]
3B01F906-1699-EB11-84F4-A81E8446D5B0
// end::pk_index_guid[]
