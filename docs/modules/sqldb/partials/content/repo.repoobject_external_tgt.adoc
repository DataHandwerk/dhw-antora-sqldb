...
= repo.RepoObject_external_tgt - V
...
* xref:repo.repoobject_external_src.adoc#column-repoobjectunderlineguid[+repo.RepoObject_external_src.RepoObject_guid+]
--
...
* xref:repo.repoobject_external_src.adoc#column-externalunderlineantoracomponent[+repo.RepoObject_external_src.external_AntoraComponent+]
--
...
* xref:repo.repoobject_external_src.adoc#column-externalunderlineantoramodule[+repo.RepoObject_external_src.external_AntoraModule+]
--
...
* xref:repo.repoobject_external_src.adoc#column-isunderlineexternal[+repo.RepoObject_external_src.is_external+]
--
...
* xref:repo.repoobject_external_src.adoc#column-isunderlinerepounderlinemanaged[+repo.RepoObject_external_src.is_repo_managed+]
--
...
* xref:repo.repoobject_external_src.adoc#column-repoobjectunderlinename[+repo.RepoObject_external_src.RepoObject_name+]
--
...
* xref:repo.repoobject_external_src.adoc#column-repoobjectunderlineschemaunderlinename[+repo.RepoObject_external_src.RepoObject_schema_name+]
--
...
* xref:repo.repoobject_external_src.adoc#column-repoobjectunderlinetype[+repo.RepoObject_external_src.RepoObject_type+]
--
...
* xref:repo.repoobject_external_src.adoc#column-sysobjectunderlinename[+repo.RepoObject_external_src.SysObject_name+]
--
...
* xref:repo.repoobject_external_src.adoc#column-sysobjectunderlineschemaunderlinename[+repo.RepoObject_external_src.SysObject_schema_name+]
--
...
* xref:repo.repoobject_external_src.adoc#column-sysobjectunderlinetype[+repo.RepoObject_external_src.SysObject_type+]
--
...
[#index-pkunderlinerepoobjectunderlineexternalunderlinetgt]
...
[#index-ukunderlinerepoobjectunderlineexternalunderlinetgtunderlineunderline2]
...
[#index-ukunderlinerepoobjectunderlineexternalunderlinetgtunderlineunderline3]
...
[#index-ukunderlinerepoobjectunderlineexternalunderlinetgtunderlineunderline4]
...
[#index-idxunderlinerepoobjectunderlineexternalunderlinetgtunderlineunderline5]
