...
|610
|
*check [workflow].[Workflow_ProcedureDependency_T_bidirectional] (should be empty)*
...
|620
|
*check [workflow].[Workflow_ProcedureDependency_T_NotInSortorder_check] (should be empty)*
