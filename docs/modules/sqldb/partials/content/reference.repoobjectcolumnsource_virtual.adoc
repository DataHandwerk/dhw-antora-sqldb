...
= reference.RepoObjectColumnSource_virtual - U
...
// tag::RepoObject_guid[]
4077342A-21A5-EB11-84FA-A81E8446D5B0
// end::RepoObject_guid[]
...
.Default: DF_RepoObjectColumnSource_virtual_RepoObjectColumn_guid
[source,sql]
----
(newsequentialid())
----
...
.Default: DF_RepoObjectColumnSource_virtual_RepoObjectColumn_guid1
[source,sql]
----
(newsequentialid())
----
...
[#index-pkunderlinerepoobjectcolumnsourceunderlinevirtual]
...
[#index-idxunderlinerepoobjectcolumnsourceunderlinevirtualunderlineunderline1]
=== idx_RepoObjectColumnSource_virtual++__++1
...
* ++FK_RepoObjectColumnSource_virtual_RepoObjectColumn++ +
...
[#index-idxunderlinerepoobjectcolumnsourceunderlinevirtualunderlineunderline2]
=== idx_RepoObjectColumnSource_virtual++__++2
...
--
* PK, Unique, Real: 0, 0, 0
* ++FK_RepoObjectColumnSource_virtual_RepoObjectColumn_source++ +
referenced: xref:repo.repoobjectcolumn.adoc[], xref:repo.repoobjectcolumn.adoc#index-pkunderlinerepoobjectcolumn[+PK_RepoObjectColumn+]
* is disabled
...
// tag::pk_index_guid[]
4177342A-21A5-EB11-84FA-A81E8446D5B0
// end::pk_index_guid[]
