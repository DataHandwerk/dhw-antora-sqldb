...
.Referencing Columns
--
* xref:reference.repoobject_referencedreferencing.adoc#column-referencedunderlineisunderlinedocsoutput[+reference.RepoObject_ReferencedReferencing.referenced_is_DocsOutput+]
* xref:reference.repoobject_referencedreferencing.adoc#column-referencingunderlineisunderlinedocsoutput[+reference.RepoObject_ReferencedReferencing.referencing_is_DocsOutput+]
* xref:repo.repoobject_gross.adoc#column-isunderlinedocsoutput[+repo.RepoObject_gross.is_DocsOutput+]
* xref:repo.repoobject_gross_persistence.adoc#column-isunderlinedocsoutput[+repo.RepoObject_gross_persistence.is_DocsOutput+]
--
...
.Referencing Columns
--
* xref:configt.type_level1type_level2type.adoc#column-typeunderlinedesc[+configT.type_level1type_level2type.type_desc+]
* xref:docs.antoranavlistpage_by_type.adoc#column-typeunderlinedesc[+docs.AntoraNavListPage_by_type.type_desc+]
...
* xref:repo.repoobject_gross_persistence.adoc#column-repoobjectunderlinetypeunderlinename[+repo.RepoObject_gross_persistence.RepoObject_type_name+]
* xref:repo.repoobject_gross_persistence.adoc#column-sysobjectunderlinetypeunderlinename[+repo.RepoObject_gross_persistence.SysObject_type_name+]
--
...
configT.type <.. repo.RepoObject_wo_referencing
...
"configT.type::type" <-- "docs.AntoraNavListPage_by_type::type"
"configT.type::type_desc" <-- "configT.type_level1type_level2type::type_desc"
"configT.type::type_desc" <-- "docs.AntoraNavListPage_by_type::type_desc"
