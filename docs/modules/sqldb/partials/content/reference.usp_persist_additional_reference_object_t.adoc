...
= reference.usp_PERSIST_additional_Reference_Object_T - P
...
reference.usp_PERSIST_additional_Reference_Object_T
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_additional_Reference_Object_T]
[cols="d,15a,d"]
|===
...
----
DELETE T
FROM [reference].[additional_Reference_Object_T] AS T
WHERE
NOT EXISTS
(SELECT 1 FROM [reference].[additional_Reference_Object] AS S
WHERE
T.[AntoraComponent] = S.[AntoraComponent]
AND T.[AntoraModule] = S.[AntoraModule]
...
FROM [reference].[additional_Reference_Object] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [reference].[additional_Reference_Object_T] AS T
...
* xref:dhw:sqldb:reference.additional_reference_object_t.adoc[]
...
*/
CREATE   PROCEDURE [reference].[usp_PERSIST_additional_Reference_Object_T]
...
--
PRINT '[reference].[usp_PERSIST_additional_Reference_Object_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":500,"Name":"delete persistence target missing in source","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_Object]","log_target_object":"[reference].[additional_Reference_Object_T]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',95,';',500,';',NULL);
...
SET @source_object = '[reference].[additional_Reference_Object]'
SET @target_object = '[reference].[additional_Reference_Object_T]'
...
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_Object]","log_target_object":"[reference].[additional_Reference_Object_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',95,';',700,';',NULL);
