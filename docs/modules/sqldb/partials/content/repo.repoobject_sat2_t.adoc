...
.Referenced Columns
--
* xref:repo.repoobject_sat2.adoc#column-sqlunderlinemodulesunderlineantora[+repo.RepoObject_sat2.sql_modules_antora+]
--
...
[#index-pkunderlinerepoobjectunderlinesat2underlinet]
