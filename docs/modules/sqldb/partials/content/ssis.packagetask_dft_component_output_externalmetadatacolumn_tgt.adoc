...
= ssis.PackageTask_Dft_Component_output_externalMetadataColumn_tgt - V
...
[#index-idxunderlinepackagetaskunderlinedftunderlinecomponentunderlineoutputunderlineexternalmetadatacolumnunderlinetgtunderlineunderline2]
=== idx_PackageTask_Dft_Component_output_externalMetadataColumn_tgt++__++2
...
[#index-idxunderlinepackagetaskunderlinedftunderlinecomponentunderlineoutputunderlineexternalmetadatacolumnunderlinetgtunderlineunderline3]
=== idx_PackageTask_Dft_Component_output_externalMetadataColumn_tgt++__++3
...
Column_refId; varchar(max)
--
- idx_PackageTask_Dft_Component_output_externalMetadataColumn_tgt__2

..
AntoraModule; varchar(50)
PackageName; varchar(200)
--
- idx_PackageTask_Dft_Component_output_externalMetadataColumn_tgt__3
