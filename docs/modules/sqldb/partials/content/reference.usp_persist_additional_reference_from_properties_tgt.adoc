...
= reference.usp_PERSIST_additional_Reference_from_properties_tgt - P
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_additional_Reference_from_properties_tgt]
[cols="d,15a,d"]
|===
...
FROM [reference].[additional_Reference_from_properties_src] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [reference].[additional_Reference_from_properties_tgt] AS T
WHERE
T.[referenced_AntoraComponent] = S.[referenced_AntoraComponent]
AND T.[referenced_AntoraModule] = S.[referenced_AntoraModule]
AND T.[referenced_Schema] = S.[referenced_Schema]
AND T.[referenced_Object] = S.[referenced_Object]
AND T.[referenced_Column] = S.[referenced_Column]
AND T.[referencing_AntoraComponent] = S.[referencing_AntoraComponent]
AND T.[referencing_AntoraModule] = S.[referencing_AntoraModule]
AND T.[referencing_Schema] = S.[referencing_Schema]
AND T.[referencing_Object] = S.[referencing_Object]
AND T.[referencing_Column] = S.[referencing_Column]
)
----
=====
...
*/
CREATE   PROCEDURE [reference].[usp_PERSIST_additional_Reference_from_properties_tgt]
...
--
PRINT '[reference].[usp_PERSIST_additional_Reference_from_properties_tgt]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_from_properties_src]","log_target_object":"[reference].[additional_Reference_from_properties_tgt]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',103,';',700,';',NULL);
...
SET @source_object = '[reference].[additional_Reference_from_properties_src]'
SET @target_object = '[reference].[additional_Reference_from_properties_tgt]'
