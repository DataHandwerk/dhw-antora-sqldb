...
= property.PropertyName_RepoObject - V
...
* xref:property.repoobjectproperty_cross.adoc#column-propertyunderlinename[+property.RepoObjectProperty_cross.property_name+]
--
...
[#index-pkunderlinepropertynameunderlinerepoobject]
