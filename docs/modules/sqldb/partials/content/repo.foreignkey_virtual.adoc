...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-foreignkeyunderlineguid[+repo.ForeignKey_virtual_Indexes.ForeignKey_guid+]
--
...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-deleteunderlinereferentialunderlineaction[+repo.ForeignKey_virtual_Indexes.delete_referential_action+]
--
...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-foreignkeyunderlinename[+repo.ForeignKey_virtual_Indexes.ForeignKey_name+]
--


[#column-isunderlineforeignkeyunderlinedisabled]
...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-referencedunderlineindexunderlineguid[+repo.ForeignKey_virtual_Indexes.referenced_index_guid+]
--
...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-referencingunderlineindexunderlineguid[+repo.ForeignKey_virtual_Indexes.referencing_index_guid+]
--
...
.Referencing Columns
--
* xref:repo.foreignkey_virtual_indexes.adoc#column-updateunderlinereferentialunderlineaction[+repo.ForeignKey_virtual_Indexes.update_referential_action+]
--
...
[#index-pkunderlineforeignkeyunderlinevirtual]
...
[#index-ukunderlineforeignkeyunderlinevirtualunderlineunderline1]
...
[#index-idxunderlineforeignkeyunderlinevirtualunderlineunderline2]
