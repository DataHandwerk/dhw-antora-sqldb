...
= repo.usp_sync_guid_RepoObjectColumn_ssas - P
...
// tag::RepoObject_guid[]
939CF1C3-0B08-EC11-8515-A81E8446D5B0
// end::RepoObject_guid[]

== RepoObject_FullDisplayName2

// tag::RepoObject_FullDisplayName2[]
repo.usp_sync_guid_RepoObjectColumn_ssas
...
// tag::adocuspsteps[]
.Steps in [repo].[usp_sync_guid_RepoObjectColumn_ssas]
[cols="d,15a,d"]
|===
...
|100
|
*config.fs_get_parameter_value ( 'sync enable', 'ssas' ) = 0*
...
// tag::description[]
* synchronizes RepoObjectColumn_guid with [ssas].[TMSCHEMA_COLUMNS_T]
// end::description[]
...
// tag::exampleusage[]
EXEC [repo].[usp_sync_guid_RepoObjectColumn_ssas]
// end::exampleusage[]
...
*/
CREATE   PROCEDURE [repo].[usp_sync_guid_RepoObjectColumn_ssas]
...
--
PRINT '[repo].[usp_sync_guid_RepoObjectColumn_ssas]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
BEGIN
PRINT CONCAT('usp_id;Number;Parent_Number: ',77,';',110,';',100);
