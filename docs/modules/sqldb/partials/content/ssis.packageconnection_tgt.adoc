...
[#index-idxunderlinepackageconnectionunderlinetgtunderlineunderline2]
=== idx_PackageConnection_tgt++__++2
...
[#index-idxunderlinepackageconnectionunderlinetgtunderlineunderline3]
=== idx_PackageConnection_tgt++__++3
...
ConnectionManagerID; uniqueidentifier
--
- idx_PackageConnection_tgt__2

..
AntoraModule; varchar(50)
PackageName; varchar(200)
--
- idx_PackageConnection_tgt__3
