...
.Referencing Columns
--
* xref:repo.indexcolumn_ssas_gross.adoc#column-indexunderlineguid[+repo.IndexColumn_ssas_gross.index_guid+]
--
...
.Referenced Columns
--
* xref:repo.indexcolumn_ssas.adoc#column-indexunderlinecolumnunderlineid[+repo.IndexColumn_ssas.index_column_id+]
--

.Referencing Columns
--
* xref:repo.indexcolumn_ssas_gross.adoc#column-indexunderlinecolumnunderlineid[+repo.IndexColumn_ssas_gross.index_column_id+]
--
...
.Referenced Columns
--
* xref:repo.indexcolumn_ssas.adoc#column-repoobjectcolumnunderlineguid[+repo.IndexColumn_ssas.RepoObjectColumn_guid+]
--

.Referencing Columns
--
* xref:repo.indexcolumn_ssas_gross.adoc#column-repoobjectcolumnunderlineguid[+repo.IndexColumn_ssas_gross.RepoObjectColumn_guid+]
--
...
.Referencing Columns
--
* xref:repo.indexcolumn_ssas_gross.adoc#column-isunderlinedescendingunderlinekey[+repo.IndexColumn_ssas_gross.is_descending_key+]
--
...
[#index-pkunderlineindexcolumnunderlinessasunderlinet]
...
[#index-idxunderlineindexcolumnunderlinessasunderlinetunderlineunderline1]
...
referenced: xref:repo.index_ssas_t.adoc[], xref:repo.index_ssas_t.adoc#index-uqunderlineindexunderlinessasunderlinet[+uq_Index_ssas_T+]


[#index-idxunderlineindexcolumnunderlinessasunderlinetunderlineunderline2]
