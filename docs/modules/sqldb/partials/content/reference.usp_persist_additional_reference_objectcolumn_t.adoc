...
= reference.usp_PERSIST_additional_Reference_ObjectColumn_T - P
...
reference.usp_PERSIST_additional_Reference_ObjectColumn_T
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_additional_Reference_ObjectColumn_T]
[cols="d,15a,d"]
|===
...
----
DELETE T
FROM [reference].[additional_Reference_ObjectColumn_T] AS T
WHERE
NOT EXISTS
(SELECT 1 FROM [reference].[additional_Reference_ObjectColumn] AS S
WHERE
...
FROM [reference].[additional_Reference_ObjectColumn] AS S
WHERE
NOT EXISTS
(SELECT 1
FROM [reference].[additional_Reference_ObjectColumn_T] AS T
...
*/
CREATE   PROCEDURE [reference].[usp_PERSIST_additional_Reference_ObjectColumn_T]
...
--
PRINT '[reference].[usp_PERSIST_additional_Reference_ObjectColumn_T]'
--keep the code between logging parameters and "START" unchanged!
--
----START
--
...
--
/*{"ReportUspStep":[{"Number":500,"Name":"delete persistence target missing in source","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_ObjectColumn]","log_target_object":"[reference].[additional_Reference_ObjectColumn_T]","log_flag_InsertUpdateDelete":"D"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',96,';',500,';',NULL);
...
SET @source_object = '[reference].[additional_Reference_ObjectColumn]'
SET @target_object = '[reference].[additional_Reference_ObjectColumn_T]'
...
/*{"ReportUspStep":[{"Number":700,"Name":"insert missing","has_logging":1,"is_condition":0,"is_inactive":0,"is_SubProcedure":0,"log_source_object":"[reference].[additional_Reference_ObjectColumn]","log_target_object":"[reference].[additional_Reference_ObjectColumn_T]","log_flag_InsertUpdateDelete":"I"}]}*/
PRINT CONCAT('usp_id;Number;Parent_Number: ',96,';',700,';',NULL);
