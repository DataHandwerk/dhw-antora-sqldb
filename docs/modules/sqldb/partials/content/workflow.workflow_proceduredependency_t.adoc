...
= workflow.Workflow_ProcedureDependency_T - U
...
* xref:workflow.workflow_proceduredependency_t_bidirectional.adoc#column-workflowunderlineid[+workflow.Workflow_ProcedureDependency_T_bidirectional.Workflow_id+]
--
...
* xref:workflow.workflow_proceduredependency_t_bidirectional.adoc#column-referencedunderlineprocedureunderlinerepoobjectunderlineguid[+workflow.Workflow_ProcedureDependency_T_bidirectional.referenced_Procedure_RepoObject_guid+]
--
...
* xref:workflow.workflow_proceduredependency_t_bidirectional.adoc#column-referencingunderlineprocedureunderlinerepoobjectunderlineguid[+workflow.Workflow_ProcedureDependency_T_bidirectional.referencing_Procedure_RepoObject_guid+]
--
...
.Referencing Columns
--
* xref:workflow.workflow_proceduredependency_t_active.adoc#column-isunderlineredundant[+workflow.Workflow_ProcedureDependency_T_active.is_redundant+]
--
...
[#index-pkunderlineworkflowunderlineproceduredependencyunderlinet]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinetunderlineunderline1]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinetunderlineunderline2]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinetunderlineunderline3]
...
[#index-idxunderlineworkflowunderlineproceduredependencyunderlinetunderlineunderline4]
