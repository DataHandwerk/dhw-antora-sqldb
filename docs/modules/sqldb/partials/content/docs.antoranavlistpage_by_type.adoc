...
// tag::RepoObject_guid[]
861293B9-DE96-EB11-84F4-A81E8446D5B0
// end::RepoObject_guid[]
...
.Referenced Columns
--
* xref:configt.type.adoc#column-type[+configT.type.type+]
--
...
[#index-idxunderlineantoranavlistpageunderlinebyunderlinetypeunderlineunderline1]
=== idx_AntoraNavListPage_by_type++__++1
