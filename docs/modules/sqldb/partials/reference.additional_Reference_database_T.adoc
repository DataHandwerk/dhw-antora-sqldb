...
.Referencing Columns
--
* xref:repo.repoobject_gross.adoc#column-external_repodatabasename[+repo.RepoObject_gross.external_RepoDatabaseName+]
--
...
[#index-pk_additional_reference_database_t]
