...
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-FirstNode_schema_name[+reference.Match_RepoObject_referenced_UspPersistence.FirstNode_schema_name+]
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-LastNode_schema_name[+reference.Match_RepoObject_referenced_UspPersistence.LastNode_schema_name+]
--
...
.Referencing Columns
--
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-First_usp_persistence_name[+reference.Match_RepoObject_referenced_UspPersistence.First_usp_persistence_name+]
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-Last_usp_persistence_name[+reference.Match_RepoObject_referenced_UspPersistence.Last_usp_persistence_name+]
--
...
.Referencing Columns
--
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-Last_usp_persistence_RepoObject_guid[+reference.Match_RepoObject_referenced_UspPersistence.Last_usp_persistence_RepoObject_guid+]
* xref:reference.Match_RepoObject_referenced_UspPersistence.adoc#column-First_usp_persistence_RepoObject_guid[+reference.Match_RepoObject_referenced_UspPersistence.First_usp_persistence_RepoObject_guid+]
--
