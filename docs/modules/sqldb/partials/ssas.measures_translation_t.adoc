...
.Referenced Columns
--
* xref:ssas.measures_translation.adoc#column-cultures_name[+ssas.Measures_translation.cultures_name+]
--
...
.Referenced Columns
--
* xref:ssas.measures_translation.adoc#column-measure_displayname[+ssas.Measures_translation.Measure_DisplayName+]
--
...
[#index-pk_measures_translation_t]
...
[#index-uk_measures_translation_t2x_1]
