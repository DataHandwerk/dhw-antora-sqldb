= [reference].[usp_PERSIST_RepoObject_ReferenceTree_referencing_0_30_T]
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_RepoObject_ReferenceTree_referencing_0_30_T]
[cols="d,15a,d"]
|===
...
* xref:reference.RepoObject_ReferenceTree_referencing_0_30_T.adoc[]
...
// tag::exampleusage[]
EXEC [reference].[usp_PERSIST_RepoObject_ReferenceTree_referencing_0_30_T]
// end::exampleusage[]
