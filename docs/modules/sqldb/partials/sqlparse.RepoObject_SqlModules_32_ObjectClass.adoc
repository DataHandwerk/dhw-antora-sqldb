...
[[column-Min_RowNumber_per_class]]
...
.Referencing Columns
--
* xref:sqlparse.RepoObject_SqlModules_39_object.adoc#column-Min_RowNumber_IdentifierList[+sqlparse.RepoObject_SqlModules_39_object.Min_RowNumber_IdentifierList+]
...
[[index-PK_RepoObject_SqlModules_32_ObjectClass]]
=== PK_RepoObject_SqlModules_32_ObjectClass

* IndexSemanticGroup: xref:index/IndexSemanticGroup.adoc#_repoobject_guid,class[RepoObject_guid,class]
+
--
...
[[index-idx_RepoObject_SqlModules_32_ObjectClass_1]]
=== idx_RepoObject_SqlModules_32_ObjectClass++__++1
