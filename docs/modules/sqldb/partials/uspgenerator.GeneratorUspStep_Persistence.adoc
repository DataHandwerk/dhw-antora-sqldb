...
[#index-UK_GeneratorUspStep_Persistence_2]
=== UK_GeneratorUspStep_Persistence++__++2

* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_usp_id,number[usp_id,Number]
+
--
* <<column-usp_id>>; int
* <<column-Number>>; int
