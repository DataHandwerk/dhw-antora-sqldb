...
[[index-idx_RepoObjectColumnProperty_InheritanceType_InheritanceDefinition__1]]
...
[[index-idx_RepoObjectColumnProperty_InheritanceType_InheritanceDefinition__2]]
...
[[index-idx_RepoObjectColumnProperty_InheritanceType_InheritanceDefinition__3]]
