...
* xref:repo.repoobject_persistence_forupdate.adoc#column-isunderlinepersistence[+repo.RepoObject_persistence_ForUpdate.is_persistence+]
...
* xref:repo.repoobject_persistence_forupdate.adoc#column-temporalunderlinetype[+repo.RepoObject_persistence_ForUpdate.temporal_type+]
--
...
// tag::description[]
include::sqldb:partial$description/repo.repoobject_persistence.adoc[]
