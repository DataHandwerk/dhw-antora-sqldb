= [reference].[usp_PERSIST_RepoObject_ReferenceTree_referenced_30_0_T]
...
// tag::adocuspsteps[]
.Steps in [reference].[usp_PERSIST_RepoObject_ReferenceTree_referenced_30_0_T]
[cols="d,15a,d"]
|===
...
* xref:reference.RepoObject_ReferenceTree_referenced_30_0_T.adoc[]
...
// tag::exampleusage[]
EXEC [reference].[usp_PERSIST_RepoObject_ReferenceTree_referenced_30_0_T]
// end::exampleusage[]
