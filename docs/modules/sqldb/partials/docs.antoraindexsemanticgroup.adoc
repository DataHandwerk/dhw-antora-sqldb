...
[#index-idxunderlineantoraindexsemanticgroupunderlineunderline1]
=== idx_AntoraIndexSemanticgroup++__++1
...
[#index-idxunderlineantoraindexsemanticgroupunderlineunderline2]
=== idx_AntoraIndexSemanticgroup++__++2
...
* xref:dhw:sqldb:docs.antoraindexsemanticgroup.adoc[] - 
