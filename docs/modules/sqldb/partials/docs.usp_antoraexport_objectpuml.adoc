...
|410
|
*export puml from [docs].[RepoObject_Plantuml_T]*
...
|420
|
*export FROM [docs].[RepoObject_Plantuml_Entity_T]*
...
// tag::description[]
include::sqldb:partial$description/docs.usp_antoraexport_objectpuml.adoc[]
// end::description[]
