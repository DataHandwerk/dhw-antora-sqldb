...
.Referenced Columns
--
* xref:reference.RepoObjectColumn_reference_union.adoc#column-referencing_RepoObject_guid[+reference.RepoObjectColumn_reference_union.referencing_RepoObject_guid+]
--
