...
.Referencing Columns
--
* xref:docs.antorapage_objectbyschema.adoc#column-cultures_name[+docs.AntoraPage_ObjectBySchema.cultures_name+]
--
...
[#index-idx_antoranavlistrepoobject_by_schema2x_1]
...
[#index-idx_antoranavlistrepoobject_by_schema2x_2]
