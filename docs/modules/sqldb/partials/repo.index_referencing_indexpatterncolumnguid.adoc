...
.Referencing Columns
--
* xref:repo.indexreferencedreferencing_hasfullcolumnsinreferencing.adoc#column-referencingunderlineindexpatterncolumnguid[+repo.IndexReferencedReferencing_HasFullColumnsInReferencing.referencing_IndexPatternColumnGuid+]
--
...
[#index-pkunderlineindexunderlinereferencingunderlineindexpatterncolumnguid]
...
[#index-idxunderlineindexunderlinereferencingunderlineindexpatterncolumnguidunderlineunderline2]
