...
// tag::RepoObject_guid[]
8F9A07F7-C23C-EC11-852D-A81E8446D5B0
// end::RepoObject_guid[]
...
* xref:dhw:sqldb:docs.usp_antoraexport_ssispartialproperties.adoc[] - 
...
// tag::adocuspsteps[]
.Steps in [docs].[usp_AntoraExport_SsisPartialProperties]
[cols="d,15a,d"]
|===
...
// tag::description[]
include::sqldb:partial$description/docs.usp_antoraexport_ssispartialproperties.adoc[]
// end::description[]
