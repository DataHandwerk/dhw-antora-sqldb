...
// tag::RepoObject_guid[]
E835C571-8103-EC11-8513-A81E8446D5B0
// end::RepoObject_guid[]
...
.Referencing Columns
--
* xref:repo.RepoObject_gross2.adoc#column-AntoraExternalReferencedList[+repo.RepoObject_gross2.AntoraExternalReferencedList+]
--
