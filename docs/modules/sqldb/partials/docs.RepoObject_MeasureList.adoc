...
.Referenced Columns
--
* xref:repo.measures_union.adoc#column-repoobject_guid[+repo.Measures_union.RepoObject_guid+]
--
...
[#index-pk_repoobject_measurelist]
...
[#index-idx_repoobject_measurelist2x_2]
