...
.Referencing Columns
--
* xref:reference.repoobject_referencedreferencing.adoc#column-referenced_is_docsoutput[+reference.RepoObject_ReferencedReferencing.referenced_is_DocsOutput+]
* xref:reference.repoobject_referencedreferencing.adoc#column-referencing_is_docsoutput[+reference.RepoObject_ReferencedReferencing.referencing_is_DocsOutput+]
