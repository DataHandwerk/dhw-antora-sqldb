...
* xref:property.repoobjectproperty_cross.adoc#column-property_name[+property.RepoObjectProperty_cross.property_name+]
--
...
* IndexSemanticGroup: xref:other/indexsemanticgroup.adoc#property_name[property_name]
+
--
