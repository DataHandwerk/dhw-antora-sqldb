...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_uspstep_id[UspStep_id]
+
--
* <<column-id>>; int
--
...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_uk_generatoruspstep_number[UK_GeneratorUspStep_Number]
+
--
* <<column-usp_id>>; int
* <<column-Number>>; int
