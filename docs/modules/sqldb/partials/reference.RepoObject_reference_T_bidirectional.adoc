...
[#column-referenced_is_persistence]
...
[#column-referenced_source_RepoObject_guid]
...
[#column-referencing_is_persistence]
...
[#column-referencing_source_RepoObject_guid]
...
[#index-idx_RepoObject_reference_T_bidirectional2x_1]
