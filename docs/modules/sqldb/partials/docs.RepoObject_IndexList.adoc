...
.Referencing Columns
--
* xref:docs.repoobject_indexlist_t.adoc#column-cultures_name[+docs.RepoObject_IndexList_T.cultures_name+]
--
...
[#index-uk_repoobject_indexlist2x_1]
...
[#index-idx_repoobject_indexlist2x_3]
