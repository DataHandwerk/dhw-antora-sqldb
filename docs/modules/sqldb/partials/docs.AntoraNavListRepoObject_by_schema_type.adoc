...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_schema_name,object_type[schema_name,object_type]
+
--
...
[#index-UK_AntoraNavListRepoObject_by_schema_type_2]
=== UK_AntoraNavListRepoObject_by_schema_type++__++2
