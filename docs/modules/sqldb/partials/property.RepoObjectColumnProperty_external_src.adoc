...
.Referenced Columns
--
* xref:property.external_repoobjectcolumnproperty.adoc#column-repoobjectcolumn_guid[+property.external_RepoObjectColumnProperty.RepoObjectColumn_guid+]
--
...
.Referenced Columns
--
* xref:property.external_repoobjectcolumnproperty.adoc#column-property_name[+property.external_RepoObjectColumnProperty.property_name+]
--
...
.Referenced Columns
--
* xref:property.external_repoobjectcolumnproperty.adoc#column-property_value[+property.external_RepoObjectColumnProperty.property_value+]
--
...
[#index-pk_repoobjectcolumnproperty_external_src]
