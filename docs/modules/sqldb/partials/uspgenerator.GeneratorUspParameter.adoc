...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_uspparameter_id[UspParameter_id]
+
--
* <<column-id>>; int
--
...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_uk_generatoruspparameter_name[UK_GeneratorUspParameter_name]
+
--
* <<column-usp_id>>; int
...
* IndexSemanticGroup: xref:other/IndexSemanticGroup.adoc#_uk_generatoruspparameter_number[UK_GeneratorUspParameter_Number]
+
--
* <<column-usp_id>>; int
* <<column-Number>>; int
